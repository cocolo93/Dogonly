"""
Django settings for dogonly_db project.
...
AUTH_USER_MODEL = 'dogonly_app.User'
ALLOWED_HOSTS = ['127.0.0.1', 'dogonly.com', 'www.dogonly.com', 'dogonly.onrender.com']
...
INSTALLED_APPS = [
    'dogonly_app.apps.DogonlyConfig',
...
WSGI_APPLICATION = 'dogonly_db.wsgi.application'
